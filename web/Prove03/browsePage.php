...
<html lang="en">
  <head>
    ...
    <title>Brian's Store - Browse</title>
  ...
  <body>
    ...
    <div class="myNav">
      <div class="container">
        <h4>Brian's Store - Browse Items</h4>
      </div>
    </div>
    ...
    <div class="container itemBox">
      <ul>
        <form action="browsePage.php" method="post">
          <li><input type="checkbox" name="bshirt" value="Brian Shirt">  Brian Shirt</input></li>
          <li><input type="checkbox" name="bcap" value="Brian Cap">  Brian Cap</input></li>
          <li><input type="checkbox" name="bjacket" value="Brian Jacket">  Brian Jacket</input></li>
          <li><input type="checkbox" name="bpants" value="Brian Pants">  Brian Pants</input></li>
          <br/>
